...
@section('content')
  <section class="error-404 py-5">
    <div class="container text-center" style="max-width: 540px;">
      ...
      <h1 class="h3 mb-3">{{ __('Sivua ei löydy', 'omakeikka-theme') }}</h1>
      <p class="text-muted mb-4">
        {{ __('Etsimääsi sivua ei löydy. Se on saatettu siirtää tai poistaa.', 'omakeikka-theme') }}
      </p>
      <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
        <a href="{{ home_url('/') }}" class="btn btn-primary">
          {{ __('Palaa etusivulle', 'omakeikka-theme') }}
        </a>
        <a href="{{ get_post_type_archive_link('occupation') }}" class="btn btn-outline-secondary">
          {{ __('Selaa ammatteja', 'omakeikka-theme') }}
        </a>
      </div>
    </div>
  </section>
